...
\Fref{fig:boundingRegions} illustrates two different ways bounding regions can be used. On the left a rectangular shape for approximation is used, while on the right the shape is broken down into a hierarchy with two levels using circles for approximation.
